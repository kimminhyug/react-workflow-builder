...
export const nodesAtom = atom<CustomNode[]>([
  {
    ...
    data: {
      label: 'Start',
      condition: '서버 1 상태 체크',
      fallback: ['1_fallback', '예비 서버'],
      status: 'done',
    },
    measured: {
      width: 72,
