...
- [2. 주요 기능](#2-주요-기능)
  - [2.1 노드 관리](#1-노드-관리)
  - [2.2 커스텀 노드 유형](#2-커스텀-노드-유형)
  - [2.3 속성 편집 패널](#3-속성-편집-패널)
  - [2.4 상태 동기화](#4-상태-동기화)
  - [2.5 실행 시뮬레이터](#5-실행-시뮬레이터-)
  - [2.6 이력 관리 시스템](#6-이력-관리-시스템)
  - [2.7 다국어(i18n)](#7-다국어i18n)
- [4. 화면 구성](#4-화면-구성)
  - [4.1 헤더 (FAB UI 형태)](#1-헤더-fab-ui-형태)
  - [4.2 패널](#2-패널)
  - [4.3 메인 작업 영역](#3-메인-작업-영역)
- [5. 기술 스택](#5-기술-스택)
- [5. 설계](#5-설계)
  - [5.1 워크플로우 구조](#1-워크플로우-구조)
  - [5.2 노드/엣지 상태](#2-노드엣지-상태)
  - [5.3 조건 타입](#3-조건-타입)
  - [5.4 시뮬레이션 컨텍스트](#4-시뮬레이션-컨텍스트)
  - [5.5 조건 정의](#5-조건-정의)
  - [5.6 기본 노드 데이터](#6-기본-노드-데이터)
  - [5.7 노드 유형별 설계](#7-노드-유형별-설계)
    - [TaskNode](#tasknode)
    - [MergeNode](#mergenode)
    - [DecisionNode](#decisionnode)
    - [Start / End](#start--end)
- [8. 실행 흐름 관리](#8-실행-흐름-관리)
  - [8.1 노드/엣지 상태](#81-노드엣지-상태)
  - [8.2 조건 처리 (DecisionNode)](#82-조건-처리-decisionnode)
  - [8.3 병합 처리 (MergeNode)](#83-병합-처리-mergenode)
  - [8.4 Task 실행 (TaskNode)](#84-task-실행-tasknode)
  - [8.5 시뮬레이션 컨텍스트 (IFlowContext)](#85-시뮬레이션-컨텍스트-iflowcontext)
  - [8.6 실행 흐름](#86-실행-흐름)
- [9. 디렉토리 구조](#9-디렉토리-구조)
  - [9.1 관리 규칙](#9-1-관리-규칙)
- [10. 설치 및 실행](#10-설치-및-실행)
  - [10.1 의존성 설치](#101-의존성-설치)
  - [10.2 개발 서버 실행](#102-개발-서버-실행)
  - [10.3 빌드](#103-빌드)
...
```
개발 서버 실행 후 http://localhost:5173에서 확인 가능
